...
webserver:
	$(CC) $(CFLAGS) -o webserver request.cc request_parser.cc ProxyHandler.cc EchoHandler.cc mime_types.cc StaticHandler.cc Not_Found_Handler.cc config_parser.cc HttpResponse.cc -std=c++0x -pthread -lboost_system
